...
public class BoreholesSplittingIT extends BoreholesProtection {
    ...
    private final DatasetContext boreholes = buildTableContext(BOREHOLES_SCRIPT, DATABASE_NAME, SCHEMA_NAME,
            BOREHOLES_TABLE_NAME, BOREHOLES_COLUMN_NAMES, BOREHOLES_COLUMN_PROTECTION_FLAGS, PROTECTED_DATABASE_NAMES,
            PROTECTED_SCHEMA_NAMES, PROTECTED_BOREHOLES_TABLE_NAMES, PROTECTED_BOREHOLES_COLUMN_NAMES,
            BOREHOLES_WHERE_CLAUSE);

    private final DatasetContext geometryColumns = buildTableContext(null, DATABASE_NAME, SCHEMA_NAME,
