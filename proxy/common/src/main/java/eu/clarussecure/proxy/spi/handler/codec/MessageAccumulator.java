 ...
 * under the License.
 */
package eu.clarussecure.proxy.spi.handler.codec;
...
/**
 * An abstract {@link ChannelHandler} that accumulates a series of message objects into a single aggregated message.
 * <p>
...
public abstract class MessageAccumulator<I, S, C extends ByteBufHolder, O extends ByteBufHolder>
     ...
     */
    protected MessageAccumulator(int maxContentLength) {
        validateMaxContentLength(maxContentLength);
        this.maxContentLength = maxContentLength;
    }

    protected MessageAccumulator(int maxContentLength, Class<? extends I> inboundMessageType) {
    ...
    protected void decode(final ChannelHandlerContext ctx, I msg, List<Object> out) throws Exception {
        ...
        if (isStartMessage(msg)) {
            ...
            //MyCompositeByteBuf content = (MyCompositeByteBuf) currentMessage.content();
            SynchronizedCompositeByteBuf content = (SynchronizedCompositeByteBuf) currentMessage.content();
    ...
    private static void appendPartialContent(SynchronizedCompositeByteBuf content, ByteBuf partialContent) {
