 ...
 */
public class MutableByteBufInputStream extends InputStream implements DataInput {
    ...
    public ByteBuf readUntil(byte... values) throws IOException {
        ...
        return readFully(len + 1);
    }

    @Override
    public int readInt() throws IOException {
        checkAvailable(Integer.BYTES);
        ensureBufferIsReadable(Integer.BYTES);
    ...
    public long readLong() throws IOException {
        ...
        ensureBufferIsReadable(Long.BYTES);
    ...
    public short readShort() throws IOException {
        ...
        ensureBufferIsReadable(Short.BYTES);
