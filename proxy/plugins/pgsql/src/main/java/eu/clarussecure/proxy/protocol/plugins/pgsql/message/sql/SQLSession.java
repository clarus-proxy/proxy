...
public class SQLSession {
    ...
    public ExtendedQueryStatus<ParseStep> addParseStep(ParseStep parseStep, Operation operation) {
        ExtendedQueryStatus<ParseStep> parseStepStatus = new ExtendedQueryStatus<>(parseStep, operation);
    ...
    public ExtendedQueryStatus<BindStep> addBindStep(BindStep bindStep, Operation operation) {
        ExtendedQueryStatus<BindStep> bindStepStatus = new ExtendedQueryStatus<>(bindStep, operation);
